...
# wygenerowanie listy
range(repeatHowManyTimes)


for index in range(repeatHowManyTimes): # index - cokolwiek mozna zamiast tego wpisac, taka jest konstrukcja kodu, ze cokolwiek tutaj sie wpisze, to on bedzie bral elementy z listy.
    print("hejo")


# 0 przypisz do zmiennej o odpowiedniej nazwie nazwy miesiaca (January, February) - mozna uzyc skrotow Jan, Feb itd... wypisz nazwy miesiaca funkcja print(). nazwy miesiaca musza byc oddzielone enterem (znak specjalny \n)
...
zdanie = "Python is a fantastic snake"
